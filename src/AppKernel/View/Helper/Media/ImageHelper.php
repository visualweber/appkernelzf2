...
class ImageHelper extends AbstractHelper implements ServiceLocatorAwareInterface {
    ...
    protected $defaultImg = 'assets/images/no-photo.jpg';
    ...
    public function generatePath($media) {
        ...
        if (is_object($media) && ($media instanceof MediaMedia) && method_exists($media, 'getId') && ($mediaId = $media->getId())):
            // $mediaId = $media->getId();
        ...
        elseif (is_string($media)):
            ...
            return $this->view->basePath($this->defaultImg);
        endif;
